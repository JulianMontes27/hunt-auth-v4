...
export default function RouteComponent() {
  ...
  const handleSendOTP = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const phoneCheckResponse = await fetch('/api/auth/verify-existing-phone', {
        method: 'POST',
        headers: {
      ...
      if (phoneCheckData.exists) {
        ...
        const verifiedCheckResponse = await fetch('/api/auth/verify-existing-phone', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        if (verifiedCheckData.isVerified) {
          setError("Este número de teléfono ya está verificado por otra cuenta. Por favor usa un número diferente.");
          return;
        }
      }
          ...
          onSuccess: async (context) => {
            ...
            try {
              ...
              if (phoneCheckData.exists) {
                ...
                console.log("User profile updated with name only (phone already in use)");
                // Optionally show a warning to the user
                console.warn(`Note: Phone number ${fullPhoneNumber} is already registered to another account`);
              } else {
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <option value="+56" className="bg-black">🇨🇱 +56</option>
                    <option value="+58" className="bg-black">🇻🇪 +58</option>
                  </select>
